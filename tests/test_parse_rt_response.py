...
class TestParseRTResponse:
    """Test cases for parse_rt_response function."""

    def test_valid_200_ok_response(self):
    ...
    def test_valid_404_response(self):
    ...
    def test_valid_500_response(self):
    ...
    def test_response_without_trailing_suffix(self):
    ...
    def test_response_with_crlf_line_endings(self):
    ...
    def test_response_200_with_different_status_text(self):
    ...
    def test_malformed_rt_header_missing_version(self):
    ...
    def test_malformed_rt_header_missing_status_code(self):
    ...
    def test_malformed_rt_header_missing_double_newline(self):
    ...
    def test_response_error_includes_response_object(self):
